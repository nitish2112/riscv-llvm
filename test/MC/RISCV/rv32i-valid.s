# RUN: llvm-mc %s -triple=riscv32 -mattr=+rv32 -show-encoding \
# RUN:     | FileCheck -check-prefixes=CHECK,CHECK-INST %s
# RUN: llvm-mc %s -triple=riscv64 -mattr=+rv64 -show-encoding \
# RUN:     | FileCheck -check-prefixes=CHECK,CHECK-INST %s
# RUN: llvm-mc -filetype=obj -triple riscv32 -mattr=+rv32 < %s \
# RUN:     | llvm-objdump -mattr=+rv32 -d - | FileCheck -check-prefix=CHECK-INST %s
# RUN: llvm-mc -filetype=obj -triple riscv64 -mattr=+rv64 < %s \
# RUN:     | llvm-objdump -mattr=+rv64 -d - | FileCheck -check-prefix=CHECK-INST %s
